...
const Location = ({ setSelectedPage }: Props) => {
  return (
    ...
    >
      <div className="mb-10 w-full bg-primary-100 p-20 text-center text-5xl text-secondary-400">
        <h1>Locations</h1>
      </div>
      <div className="container flex w-full flex-col justify-around py-20 md:flex-row">
